...
public class Admin_show_bazar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            String query1="insert into showbazar(Time_Bazar,Diamond,Milan_Day,Rajdhani_Day,Supreme_Day,Kalyan,Milan_Night,Rajdhani_Night,Supreme_Night,Bombay_Bazar,Kalyan_Night,Worli_Mumbai,Bhagyalaxmi,Jodi_Bazar,MP_Day,Gali,Biswar,Gaziabad,Farida_bad,Kalyani) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
